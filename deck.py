...
def testing():
    ...
    deck = Deck()
    # print(deck.get_slot_center('1'))
    # print(deck.get_slot_center('2'))
    # print(deck.get_slot_center('3'))
    # print(deck.get_slot_center('4'))
    # print(deck.get_slot_center('5'))
    # print(deck.get_slot_center('6'))
    # print(deck.get_slot_center('7'))
    # print(deck.get_slot_center('8'))
    # print(deck.get_slot_center('9'))
    # print(deck.get_slot_center('10'))
    # print(deck.get_slot_center('11'))
    # print(deck.get_slot_center('12'))

    # print(deck.get_slot_definition('5')['position'][0])
    mydeck = Deck()
    print(mydeck.get_slot_center('1'))

    # print(deck.get_fixed_trash())

    # print(deck.position_for('5'))
