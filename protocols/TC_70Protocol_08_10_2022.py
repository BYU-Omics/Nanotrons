...
models = myProtocol.load_labware_setup('TC70_08_10_2022.json')
...
myProtocol.aspirate_from(2650, custom('A5'), withdraw_rate)
...
myProtocol.set_lid_temp(70)
myProtocol.set_block_temp(70, 15)
