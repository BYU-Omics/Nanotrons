...
wells_per_group = 5 
group_01_wells = ['F13','G13','H13','I13','J13']
group_02_wells = ['F14','G14','H14','I14','J14']
group_03_wells = ['F15','G15','H15','I15','J15']
group_04_wells = ['F16','G16','H16','I16','J16']
group_05_wells = ['F17','G17','H17','I17','J17']
group_06_wells = ['K13','K15','K17','K19','K21']
group_07_wells = ['K14','K16','K18','K20','K22']
...
for well in group_06_wells:
    ...
    myProtocol.dispense_to(target_delivery_volume, corning_384(well), infusion_rate) # drop off target volume
    myProtocol.dispense_to(0, dip_water, infusion_rate) # wash off outside of tip
    myProtocol.dispense_to(0, corning_384(group_07_wells[blank_well_index]), infusion_rate) # wash off outside of tip
    blank_well_index +=1
myProtocol.dispense_to(0, empty_well, infusion_rate) # Code goes crazy on first command of for loop, this line protects everything else
myProtocol.dispense_to(100, waste_water, infusion_rate) #removes 100 nL buffer volume
