...
myProtocol.dispense_to(100, corning_384('G6'))
myProtocol.dispense_to(100, corning_384('G7'))
myProtocol.dispense_to(100, corning_384('G8'))
myProtocol.dispense_to(100, corning_384('G9'))
myProtocol.dispense_to(100, corning_384('G10'))
...
myProtocol.dispense_to(50, corning_384('H6'))
myProtocol.dispense_to(50, corning_384('H7'))
myProtocol.dispense_to(50, corning_384('H8'))
myProtocol.dispense_to(50, corning_384('H9'))
myProtocol.dispense_to(50, corning_384('H10'))
...
myProtocol.dispense_to(20, corning_384('I6'))
myProtocol.dispense_to(20, corning_384('I7'))
myProtocol.dispense_to(20, corning_384('I8'))
myProtocol.dispense_to(20, corning_384('I9'))
myProtocol.dispense_to(20, corning_384('I10'))
myProtocol.mid_wash()

myProtocol.aspirate_from(60, custom_small('D1'))
myProtocol.dispense_to(0, custom('D1'))

myProtocol.dispense_to(10, corning_384('J6'))
myProtocol.dispense_to(10, corning_384('J7'))
myProtocol.dispense_to(10, corning_384('J8'))
myProtocol.dispense_to(10, corning_384('J9'))
myProtocol.dispense_to(10, corning_384('J10'))

myProtocol.mid_wash()
myProtocol.aspirate_from(30, custom_small('D1'))
myProtocol.dispense_to(0, custom('D1'))

myProtocol.dispense_to(5, corning_384('K1'))
myProtocol.dispense_to(5, corning_384('K2'))
myProtocol.dispense_to(5, corning_384('K3'))
myProtocol.dispense_to(5, corning_384('K4'))
myProtocol.dispense_to(5, corning_384('K5'))
myProtocol.mid_wash()
