...
metadata = {
	'protocolName': 'Fluore_Dispense_Test_4-14-23.py', 
...
wells_per_group = 6 
group_01_wells = ['A13','B13','C13','D13','E13']
group_02_wells = ['A14','B14','C14','D14','E14']
group_03_wells = ['A15','B15','C15','D15','E15']
group_04_wells = ['A16','B16','C16','D16','E16']
group_05_wells = ['A17','B17','C17','D17','E17']
group_06_wells = ['A18','B18','C18','D18','E18']
...
print("\nStarting mix_1 individual dispense!")
print("Time: ", {time.strftime("%H:%M:%S", time.gmtime())}, "\n")
