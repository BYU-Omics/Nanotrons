...
wells_per_group = 5 
group_01_wells = ['K1','L1','M1','N1','O1']
group_02_wells = ['K2','L2','M2','N2','O2']
group_03_wells = ['K3','L3','M3','N3','O3']
group_04_wells = ['K4','L4','M4','N4','O4']
group_05_wells = ['K5','L5','M5','N5','O5']
group_06_wells = ['P1','P3','P5','P7','P9']
group_07_wells = ['P2','P4','P6','P8','P10']
